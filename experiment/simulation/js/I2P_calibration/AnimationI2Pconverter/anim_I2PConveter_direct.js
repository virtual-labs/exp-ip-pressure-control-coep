//var a = 5;
function anim_ItoPconveter_direct(inputValue,OutputValue){	
	//paper = new Raphael(document.getElementById('anim_canvas_direct'), '100%', 500);
		var w = 900;
    var h = 500;
...
var width = $(window).width();
 ...
 x = 50;
	...
	var IPOtherParts = OtherParts_d(x,y,inputValue);
	var nozzelScrew;
	var flapperscrew;
};
...
function OtherParts_d (x,y,inputValue)
{
	
	// side magnet start
	
	paper.path('M'+(x+375)+' '+(y-60)+' l 0 55 15 0 0 -55 z' ).attr({'fill':'#fff','stroke':'black', 'stroke-width':'2'});
	paper.path('M'+(x+320)+' '+(y-60)+' l 0 55 15 0 0 -55 z' ).attr({'fill':'#fff','stroke':'black', 'stroke-width':'2'});
	
	paper.path('M'+(x+375)+' '+(y-48)+' l 15 -6 70 0' ).attr({'stroke':'black', 'stroke-width':'2'});
	paper.path('M'+(x+375)+' '+(y-38)+' l 15 -6 z' ).attr({'stroke':'black', 'stroke-width':'2'});
	paper.path('M'+(x+375)+' '+(y-28)+' l 15 -6 z' ).attr({'stroke':'black', 'stroke-width':'2'});
	paper.path('M'+(x+375)+' '+(y-18)+' l  15 -6 ' ).attr({'stroke':'black', 'stroke-width':'2'});
	
	paper.path('M'+(x+320)+' '+(y-48)+' l 15 -6 ' ).attr({'stroke':'black', 'stroke-width':'2'});
	paper.path('M'+(x+320)+' '+(y-38)+' l 15 -6 z' ).attr({'stroke':'black', 'stroke-width':'2'});
	paper.path('M'+(x+320)+' '+(y-28)+' l 15 -6 z' ).attr({'stroke':'black', 'stroke-width':'2'});
	paper.path('M'+(x+320)+' '+(y-18)+' l  15 -6 ' ).attr({'stroke':'black', 'stroke-width':'2'});
	paper.path('M'+(x+460)+' '+(y-18)+' l -140 0' ).attr({'stroke':'black', 'stroke-width':'2'}).toBack();
	
	paper.path('M'+(x+290)+' '+(y+20)+' l 0 -80 20 0 0 60 35 0 0 -60 20 0 0 60 35 0 0 -60 20 0 0 80 -130 0' ).attr({'fill':'#fff','stroke':'black', 'stroke-width':'2'});
	// side magnet end
	...
	paper.text((x+80), (y+190), "Restriction").attr({
		stroke : 'black',
		'font-size' : 15,
		"font-family": "sans-serif" 
	});
